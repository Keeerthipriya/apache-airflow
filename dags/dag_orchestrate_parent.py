...
def dag_orchestrate_parent():
    ...
    trigger_first_dag=TriggerDagRunOperator(
        task_id="trigger_first_archestrator_dag",
        trigger_dag_id="first_orchestrator_dag",
        wait_for_completion=True # Optional (This is slow because it will not run your task asynchronously): waits for the triggered DAG to complete
    )

    trigger_second_dag=TriggerDagRunOperator(
        task_id="trigger_second_archestrator_dag",
